...
log "Strategies: 18 | Timerange: $TIMERANGE"

# 1. BreadthMomentumFadeV2 — 15m, MOT8, no DCA, MoutonMeanRev, 9 params → 400 epochs
run_strategy BreadthMomentumFadeV2 BreadthMomentumFadeV1 breadth_momentum_fade_v2.py 15m hl_120pairs_mot8.json MoutonMeanRevHyperOptLoss 400 0
