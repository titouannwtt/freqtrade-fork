...
- 💡 **RSI 30 périodes (pas 14)** — Applicable quand: TF très hautes 3d/1w où les indicateurs classiques ont encore un edge (niveau de Beetcoin). Sur TF basses 15m-4h (notre cas), cet ajustement n'apporte rien — préférer indicateurs custom (cf. #42). (tips.txt #47, Beetcoin)
